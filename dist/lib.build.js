...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        _search: (0, _utils.debounce)(function (newValue, context) {
	            if (!newValue) {
	                context.dataItems = context.dataItemsOriginal;
	                context.notFound = false;
	            } else {
	                var items = context.dataItemsOriginal.filter(function (el) {
