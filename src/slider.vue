<template>
    <div class="mdl-slider__container">
        <input ref="input" type="range" class="mdl-slider mdl-js-slider is-upgraded" :min="min" :max="max" :step="step" v-model="valueNumber" @input="onInput" data-upgraded=",MaterialSlider" :disabled="disabled">
